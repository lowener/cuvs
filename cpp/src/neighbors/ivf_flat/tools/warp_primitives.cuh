...
namespace raft {
  ...
  struct is_shuffleable {
    static constexpr bool value =
      cuda::std::is_same_v<T, int> || cuda::std::is_same_v<T, unsigned int> || cuda::std::is_same_v<T, long> ||
      cuda::std::is_same_v<T, unsigned long> || cuda::std::is_same_v<T, long long> ||
      cuda::std::is_same_v<T, unsigned long long> || cuda::std::is_same_v<T, float> || cuda::std::is_same_v<T, double>;
  };
  ...
  {
    using UnitT =
      cuda::std::conditional_t<is_multiple_v<T, int>,
                        unsigned int,
