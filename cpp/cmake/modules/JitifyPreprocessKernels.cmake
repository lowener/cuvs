...
function(jit_preprocess_files)
  ...
  set(includes)
  get_target_property(raft_raw_includes raft::raft INTERFACE_INCLUDE_DIRECTORIES)
  foreach(inc IN LISTS raft_raw_includes CUDAToolkit_INCLUDE_DIRS)
    list(APPEND includes "-I${inc}")
  endforeach()
  foreach(ARG_FILE ${ARG_FILES})
    set(ARG_OUTPUT ${CUVS_GENERATED_INCLUDE_DIR}/include/jit_preprocessed_files/${ARG_FILE}.jit.hpp)
...
if(NOT (EXISTS "${CUVS_GENERATED_INCLUDE_DIR}/include"))
  make_directory("${CUVS_GENERATED_INCLUDE_DIR}/include")
endif()
...
set(cache_path "$ENV{HOME}/.cuvs")
if(ENV{LIBCUVS_KERNEL_CACHE_PATH})
  set(cache_path "$ENV{LIBCUVS_KERNEL_CACHE_PATH}")
endif()
cmake_path(APPEND cache_path "${CUVS_VERSION}/")
