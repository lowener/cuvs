 ...
 * @endcode
 */
[[deprecated]] std::unique_ptr<index<uint8_t>> from_cagra(
  raft::resources const& res,
  const index_params& params,
 ...
 * @endcode
 */
[[deprecated]] void search(raft::resources const& res,
                           const search_params& params,
 ...
 * @endcode
 */
[[deprecated]] void serialize(raft::resources const& res,
 ...
 * @endcode
 */
[[deprecated]] void deserialize(raft::resources const& res,
                                const index_params& params,
                                const std::string& filename,
                                int dim,
                                cuvs::distance::DistanceType metric,
